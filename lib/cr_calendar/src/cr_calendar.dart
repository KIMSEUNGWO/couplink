...
import 'package:couplink_app/cr_calendar/src/customization/builders.dart';
...
import 'package:couplink_app/cr_calendar/src/month_item.dart';
import 'package:couplink_app/cr_calendar/src/utils/debouncer.dart';
...
final class CrCalendarController extends ChangeNotifier {
  ...
  void addEvents(List<CalendarEventModel> events) {
    final newEvents = List<CalendarEventModel>.from(events);
  ...
  void _distinctRemove() {
    events = Set<CalendarEventModel>.from(events!).toList();
  }
